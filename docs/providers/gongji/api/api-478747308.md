  ...
  /api/storage/encrypt/check:
    post:
      ...
      description: >-
        ...
        校验对象存储桶、目录、Endpoint、AccessKey、SecretKey 是否可用，不创建对象存储记录。
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-478747308-run
components:
  schemas:
    NilResponseEnvelope:
      type: object
