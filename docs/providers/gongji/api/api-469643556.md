...
paths:
  /api/job/queue/encrypt/push:
    post:
            ...
            application/json:
              schema:
                ...
                properties:
                  ...
                  data:
                    anyOf:
                      - $ref: '#/components/schemas/QueuedJobGroupId'
                      - type: 'null'
                required:
                  - code
                  - message
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-469643556-run
components:
  schemas:
    ServicePortDto:
      type: object
