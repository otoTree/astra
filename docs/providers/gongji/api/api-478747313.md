...
info:
  ...
  version: 1.0.0
paths:
  /api/storage/s3/metadata/list:
    post:
      summary: 浏览对象存储已导入元数据
      deprecated: false
      description: >-
        ...
        浏览对象存储中已预热导入的元数据目录和文件，用于查看导入结果或选择待删除对象。
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-478747313-run
components:
  schemas:
